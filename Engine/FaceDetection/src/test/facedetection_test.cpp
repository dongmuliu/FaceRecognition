...
// const char* img_path = "D:/face recognition/FaceDetection/FaceDetection/1.png";
 ...
 seeta::FaceDetection detector("D:/face recognition/FaceDetection/x64/Debug/seeta_fd_frontal_v1.0.bin");
  ...
  cv::Mat img = cv::imread("D:/face recognition/FaceDetection/x64/Debug/2.png", CV_LOAD_IMAGE_UNCHANGED);
  if(img.empty())
...
-1;
  ...
  //cv::Mat img = cv::imread("D: / face recognition / FaceDetection / FaceDetection / 1.jpg", cv::IMREAD_UNCHANGED);
  cv::Mat img_gray;
  if (img.channels() != 1)
